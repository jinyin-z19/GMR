...
ROBOT_XML_DICT = {
    ...
    "azureloong_v9": ASSET_ROOT / "azureloong_v9" / "azureloong_v9.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "azureloong_v9": IK_CONFIG_ROOT / "smplx_to_azureloong_v9.json",
    },
    "bvh_lafan1":{
        ...
        "azureloong_v9": IK_CONFIG_ROOT / "bvh_lafan1_to_azureloong_v9.json",
    },
    "bvh_nokov":{
        "unitree_g1": IK_CONFIG_ROOT / "bvh_nokov_to_g1.json",
        "azureloong_v9": IK_CONFIG_ROOT / "bvh_nokov_to_azureloong_v9.json",
    },
    "bvh_xsens":{
